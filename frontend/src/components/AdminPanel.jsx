    ...
    <div className="max-w-[98vw] 2xl:max-w-[1600px] mx-auto bg-gradient-to-br from-white via-gray-50 to-blue-50 rounded-3xl shadow-3xl p-4 sm:p-12 mt-2 sm:mt-10 border border-gray-100 animate-fade-in min-h-[80vh]">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-6">
        ...
        <div className="flex flex-wrap gap-4 items-center justify-end w-full sm:w-auto">
          ...
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M12 3v12m0 0l-4-4m4 4l4-4" /><path d="M4 17h16" /></svg>
            Экспорт справочников
          </button>
          <label className="bg-gradient-to-r from-green-400 to-emerald-500 hover:from-green-500 hover:to-emerald-600 text-white px-5 py-3 rounded-2xl shadow-xl font-bold text-lg transition-all duration-200 cursor-pointer active:scale-95 focus:outline-none focus:ring-2 focus:ring-green-300 flex items-center">
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M12 21V9m0 0l-4 4m4-4l4 4" /><path d="M4 7h16" /></svg>
            Импорт справочников
        ...
        <div className="mb-10 border-b pb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-6 bg-white/80 rounded-2xl p-6 shadow-xl border border-gray-100 mb-4">
            <div className="flex flex-col gap-2 w-full md:w-auto">
              <input value={newGroup.name} onChange={e => { setNewGroup(g => ({ ...g, name: e.target.value })); setGroupErrors(errors => ({ ...errors, name: undefined })); }} className={`border-2 rounded-xl px-3 py-2 w-full md:w-40 bg-white focus:ring-2 focus:ring-blue-200 focus:outline-none text-base ${groupErrors.name ? "border-red-400" : "border-gray-200"}`} placeholder="Название" />
      ...
      {tab === "freeze" && (
        <div className="mb-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6 bg-white/80 rounded-2xl p-6 shadow-xl border border-gray-100 mb-4">
            ...
            <button onClick={saveFreezeSettings} className="bg-gradient-to-r from-blue-400 to-indigo-500 hover:from-blue-500 hover:to-indigo-600 text-white px-7 py-3 rounded-2xl shadow-xl font-bold text-lg transition-all duration-200 active:scale-95 focus:outline-none focus:ring-2 focus:ring-blue-300">Сохранить</button>
          </div>
