...
const Table = ({ clients, onEdit, onDelete, periods, groups, onExtend }) => {
  ...
  return (
    <div className="overflow-x-auto rounded-3xl shadow-3xl bg-white border border-gray-100 text-xs sm:text-sm animate-fade-in">
      <table className="min-w-full table-auto">
        <thead>
          <tr className="bg-gradient-to-r from-gray-50 to-gray-100 text-gray-600 uppercase tracking-wider text-base">
