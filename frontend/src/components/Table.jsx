...
// Таблица клиентов
const Table = ({ clients, onView, onEdit, onDelete, periods, groups, onExtend }) => {
  ...
  return (
    <div className="overflow-x-auto rounded-lg shadow-lg bg-white border border-gray-100 text-xs sm:text-sm">
      <table className="min-w-full table-auto">
        <thead>
          <tr className="bg-gray-50 text-gray-600 uppercase tracking-wider text-base">
        ...
        <tbody>
          {clients.length === 0 && (
            <tr>
              <td colSpan={9} className="p-12 text-center text-gray-400 bg-gray-50 rounded-b-lg">
            ...
            return (
              ...
              >
                ...
                <td className="p-4 text-right flex gap-2 justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-200" onClick={e => e.stopPropagation()}>
                  <button
                    title="Продлить"
                    className="bg-green-100 hover:bg-green-200 text-green-800 p-2 rounded-lg shadow font-semibold transition"
                  ...
                  <button
                    title="Редактировать"
                    className="bg-yellow-100 hover:bg-yellow-200 text-yellow-800 p-2 rounded-lg shadow font-semibold transition"
                  ...
                  <button
                    title="Удалить"
                    className="bg-red-100 hover:bg-red-200 text-red-700 p-2 rounded-lg shadow font-semibold transition"
